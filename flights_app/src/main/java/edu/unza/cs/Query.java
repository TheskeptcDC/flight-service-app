...
public class Query {
  ...
  public void openConnection() throws IOException, SQLException {
    ...
    // Updated connection URL for MySQL
    String connectionUrl = String.format("jdbc:mysql://localhost:3306/flight_services_app?allowPublicKeyRetrieval=true&useSSL=false", 
        serverURL, dbName);
    ...
    conn = DriverManager.getConnection(connectionUrl, adminName, password);
